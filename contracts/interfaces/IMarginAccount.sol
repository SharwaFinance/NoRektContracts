...
interface IMarginAccount {
     ...
     * @param newModularSwapRouter The address of the new modular swap router.
     */
    event UpdateModularSwapRouter(address newModularSwapRouter);
     ...
     */
    event UpdateAvailableErc20(address[] availableErc20);
     ...
     * @param value The availability status (true or false).
     */
    event UpdateIsAvailableErc20(address token, bool value);
     ...
     */
    event UpdateAvailableErc721(address[] availableErc721);
     ...
     * @param value The availability status (true or false).
     */
    event UpdateIsAvailableErc721(address token, bool value);

    event UpdateErc721Limit(uint newErc721Limit);

    event UpdateLiquidatorFee(uint newLiquidatorFee);
    ...
    /**
     * @dev Emitted when an exercise operation is performed.
     * @param marginAccountID The ID of the margin account.
     * @param tokenId The ID of the ERC721 token being exercised.
     * @param tokenIn The address of the input token.
     * @param tokenOut The address of the output token.
     * @param amountIn The amount of input tokens used in the exercise.
     */
    event Exercise(
    ...
    /**
     * @dev Emitted when a liquidation operation involving ERC20 tokens occurs.
     * @param marginAccountID The ID of the margin account.
     * @param tokenIn The address of the input token (usually the token being liquidated).
     * @param tokenOut The address of the output token (usually debt token).
     * @param amountIn The amount of input tokens used for liquidation.
     * @param amountOut The amount of output tokens obtained from liquidation.
     */
    ...
    /**
     * @dev Emitted when a liquidator receives a commission.
     * @param amount The amount of commission paid to the liquidator.
     */
    event LiquidatorCommission(uint amount);

    /**
     * @dev Emitted when the insurance pool does not have enough funds to cover a liquidation shortfall.
     * @param marginAccountID The ID of the margin account.
     * @param token The address of the token for which the insurance pool is depleted.
     * @param amountNeeded The amount that was needed from the insurance pool.
     * @param actualBalance The actual balance available in the insurance pool.
     */
    event InsurancePoolDepleted(
        uint indexed marginAccountID,
