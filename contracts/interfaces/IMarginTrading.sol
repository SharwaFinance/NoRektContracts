...
interface IMarginTrading {
    ...
    /**
     * @notice Revokes the ONE_CLICK_PROXY_ROLE from the specified account.
     * @param account The address from which the role will be revoked.
     */
    function revokeOneClickProxyRole(address account) external;

    /**
     * @notice Revokes the LIQUIDATOR_ROLE from the specified account.
     * @param account The address from which the role will be revoked.
     */
    function revokeLiquidatorRole(address account) external;
    ...
    ) external returns (uint marginAccountValue);

    /**
     * @notice Calculates the total value of a margin account using Uniswap V3 prices.
     * @param marginAccountID The ID of the margin account.
     * @return marginAccountValue The total value of the margin account calculated via Uniswap V3.
     */
    ...
    function calculateDebtWithAccruedInterest(
        uint marginAccountID
    ) external returns (uint debtSizeInUSDC);

    /**
     * @notice Gets the margin account ratio using the debt-based valuation method.
     * @param marginAccountID The ID of the margin account.
     * @return The margin account ratio calculated based on the value of debt positions.
     */
     ...
     */
    function getMarginAccountRatio(
        uint marginAccountID
    ) external returns (uint);
     ...
     * @param minTotalMarginAccountValue The minimum total margin account value for slippage check.
     */
    function liquidate(
        uint marginAccountID,
     ...
     */
    event Liquidate(uint indexed marginAccountID, address liquidator);
