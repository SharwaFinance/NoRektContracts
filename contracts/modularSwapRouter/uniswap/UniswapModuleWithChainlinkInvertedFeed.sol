 ...
 * @author 0nika0
 */
contract UniswapModuleWithChainlinkInvertedFeed is UniswapModuleBase {
    ...
    function getPositionValue(
        ...
        revert(
            "getPositionValue: oracle-less module cannot be used for valuation"
        );
    }
    ...
    {
        uint256 expectedAmountOut = _getInputPositionValueView(amount);
    ...
    {
        uint256 expectedAmountIn = _getPositionValueView(amount);
    ...
    function _getPositionValueView(
        ...
        require(chainlinkDecimals > tokenInDecimals, "invalid tokenIn");
        uint diffDecimals = chainlinkDecimals - tokenInDecimals;
    ...
    function _getInputPositionValueView(
        ...
        return
            (amountOut * (10 ** tokenOutDecimals) * (10 ** diffDecimals)) /
            latestPrice;
    }
}
